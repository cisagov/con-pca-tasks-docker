...
issue](https://github.com/cisagov/con-pca-tasks-docker/issues) in this
...
request](https://github.com/cisagov/con-pca-tasks-docker/pulls), you will
...
pyenv virtualenv <python_version_to_use> con-pca-tasks-docker
pyenv local con-pca-tasks-docker
